...
export function SidebarNav({
  ...
  return (
    <>
      <aside className={classNames('h-screen w-[280px] max-w-[85vw] flex-col border-r border-[color:var(--stroke)] bg-[color:var(--sidebar)] sm:max-w-[280px] pb-16 sm:pb-0', className)}>
        {/* Header */}
