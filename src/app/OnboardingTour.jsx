        ...
        {step === 1 ? (
          <div className="p-6 sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-sm text-center text-sm leading-relaxed text-[color:var(--ink-soft)]">
              O <strong>jURIS-APP</strong> e o seu assistente juridico angolano com inteligencia artificial.
            </p>
            <div className="mt-5 space-y-2.5">
              {[
                { title: 'Pesquise leis', desc: 'Pergunte sobre qualquer ramo do direito angolano e receba respostas fundamentadas com citacoes.' },
                { title: 'Carregue documentos', desc: 'Anexe PDFs e o assistente analisa-os como fonte prioritaria nas respostas.' },
                { title: 'Pesquise jurisprudencia', desc: 'Consulte acordaos do Tribunal Supremo e Tribunal Constitucional.' },
                { title: 'Use a voz', desc: 'Fale com o assistente — ele transcreve e responde em audio.' },
              ].map((item) => (
          ...
          <div className="p-6 sm:p-8">
            ...
            <p className="mx-auto mt-2 max-w-sm text-center text-sm text-[color:var(--ink-soft)]">
              Pode alterar estas preferencias a qualquer momento nas <strong>Definicoes</strong>.
            </p>

            <AIPrefForm onFinish={onFinish} skipText="Usar padrao" />
          </div>
        )}
      </div>
    </div>
